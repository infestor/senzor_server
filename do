...
/Users/evil/raspberrypi/bin/arm-willtm-linux-gnueabi-g++ -Wall -std=gnu++0x -O3 -ggdb -pthread -lpthread -shared-libgcc -fno-use-linker-plugin main.cpp support.cpp cfg_files.cpp node_values.cpp uart.cpp -o server
