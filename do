...
/Users/evil/raspberrypi/bin/arm-willtm-linux-gnueabi-g++ -Wall -std=gnu++0x -O3 -ggdb -pthread -lpthread -shared-libgcc -fno-use-linker-plugin main.cpp support.cpp cfg_files.cpp uart.cpp node_values.cpp -o server

#/Users/evil/raspberrypi/bin/arm-willtm-linux-gnueabi-g++ -Wall -std=gnu++0x -O3 -ggdb -pthread -lpthread -shared-libgcc -fno-use-linker-plugin -march=armv6zk -mcpu=arm1176jzf-s -mfloat-abi=hard -mfpu=vfp main.cpp support.cpp cfg_files.cpp uart.cpp node_values.cpp -o server
...
scp -P 28802 ./server evil@sailtrack.eu:/home/server
